...
<%
	...
	String sql = "select * from student where name like ? and address like ?";
	// int sql = "select * from student where year = ?";
	String name1 = '%' + request.getParameter("sname1") + "%";
	String name2 = '%' + request.getParameter("sname2") + "%";
	...
	try {
		...
		pstmt.setString(1, name1); // ?기준으로 1자리에 name을 넣겠다.
		pstmt.setString(2, name2); // ?기준으로 1자리에 name을 넣겠다.
